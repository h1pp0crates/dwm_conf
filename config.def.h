...
static const char *fonts[]          = { "Roboto Mono Medium 13", "HackNerdFont-Italic:size=13", "Segoe UI Emoji:style=Regular:size=13" };
static const char dmenufont[]       = "roboto mono 13";
...
static const Key keys[] = {
    ...
    { MODKEY,						XK_v,			spawn,		    SHCMD("vmware")},
	...
	{ MODKEY,						XK_a,			spawn,			SHCMD("edb")},
	{ MODKEY,						XK_g,			spawn,			SHCMD("steam")},
	{ MODKEY,						XK_w,			spawn,			SHCMD("nitrogen")},
	{ MODKEY|ShiftMask,				XK_s,			spawn,			SHCMD("obs")},
	{ MODKEY|ShiftMask,				XK_p,			spawn,			SHCMD("kolourpaint")},
	{ MODKEY,						XK_c,			spawn,		    SHCMD("rofi -modi 'clipboard:greenclip print' -show clipboard")},
	...
	{ MODKEY,						F10,					 spawn,	SHCMD("systemctl suspend")},
